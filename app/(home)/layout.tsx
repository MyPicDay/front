...
export default function HomeLayout({
  ...
  useEffect(() => {
    ...
    if (isClient && authStatusResolved && !isLoggedIn && !accessToken) {
      // TESAT:  true true false null
      console.log("TESAT: ", isClient, authStatusResolved, isLoggedIn, accessToken);
      router.replace('/login');
    }
  }, [isClient, authStatusResolved, isLoggedIn, accessToken, router]);
